...
Introduction
============
dirt is a `Python <http://www.python.org/>`_ and `CouchDB <http://couchdb.apache.org/>`_ application for oversight and tracking of remotely-executed jobs.
...
Visit `the site <http://localhost:5984/myproject/_design/myproject/index.html>`_ and watch the results roll in.
